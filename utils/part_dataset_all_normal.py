...
class PartNormalDataset():
    def __init__(self, root, npoints = 2500, classification = False, split='train', normalize='shape_unit', return_cls_label = False):
...
if __name__ == '__main__':
    ...
    np.savetxt('./y.xyz',np.concatenate((ps,normal),axis=1))
